...
const permLabel = (key) => ({
    ...
    konfirmasi_icu:   'Konfirmasi Bed (ICU)',
    tolak_icu:        'Tolak (ICU)',
    catat_tanpa_bed:  'Catat Tanpa Bed',
    konfirmasi_masuk: 'Konfirmasi Pasien Masuk',
    pulangkan:        'Pulangkan Pasien',
    buat_surat:       'Buat Surat Permintaan',
    approve_admisi:   'Approve + Catatan (Admisi)',
    tolak_admisi:     'Tolak (Admisi)',
    booking_bed_icu:  'Tentukan Bed (ICU)',
    tambah:           'Tambah',
    edit:             'Edit',
    hapus:            'Hapus',
