...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // Seed data RS lokal hanya jika tidak pakai SQL Server
        if (! \App\Models\Concerns\UsesRsusConnection::rsusIsAvailableStatic()) {
            $this->seedLocalRsData();
        }

        // Seed data transaksional dummy (selalu, untuk testing)
    ...
    private function truncateSafe(array $models): void
    {
        ...
        if ($driver === 'mysql') {
            ...
            // SQL Server: disable FK constraints per tabel tidak didukung via TRUNCATE,
            // pakai DELETE yang jauh lebih aman
            foreach ($models as $model) {
                try {
    ...
    private function seedLocalRsData(): void
    {
        $this->command->info('→ Mode lokal: seed data RS ke DB lokal...');

        $this->truncateSafe([
            MCaraBayar::class, StatusKamar::class, MRuangMaster::class,
            MKelas::class, RegistrasiPasien::class, Pendaftaran::class,
        ]);
        ...
        ] as $p) RegistrasiPasien::create($p);

        // PENDAFTARAN
        foreach ([
            ['No_Reg'=>'REG-2026-001','No_MR'=>'MR-001','Kode_Masuk'=>'IGD','Kode_Asal'=>'UGD','Kode_Bayar'=>'1','PermintaanDPJP'=>'dr. Andi Sp.An', 'Kode_Dokter'=>'DR-001','NameUser'=>'poli.dalam'],
            ['No_Reg'=>'REG-2026-002','No_MR'=>'MR-002','Kode_Masuk'=>'IGD','Kode_Asal'=>'UGD','Kode_Bayar'=>'2','PermintaanDPJP'=>'dr. Budi Sp.JP', 'Kode_Dokter'=>'DR-002','NameUser'=>'poli.jantung'],
            ['No_Reg'=>'REG-2026-003','No_MR'=>'MR-003','Kode_Masuk'=>'IGD','Kode_Asal'=>'UGD','Kode_Bayar'=>'3','PermintaanDPJP'=>'dr. Citra Sp.PD','Kode_Dokter'=>'DR-003','NameUser'=>'poli.dalam'],
            ['No_Reg'=>'REG-2026-004','No_MR'=>'MR-004','Kode_Masuk'=>'IGD','Kode_Asal'=>'UGD','Kode_Bayar'=>'1','PermintaanDPJP'=>'dr. Andi Sp.An', 'Kode_Dokter'=>'DR-001','NameUser'=>'poli.jantung'],
            ['No_Reg'=>'REG-2026-005','No_MR'=>'MR-005','Kode_Masuk'=>'IGD','Kode_Asal'=>'UGD','Kode_Bayar'=>'1','PermintaanDPJP'=>'dr. Budi Sp.JP', 'Kode_Dokter'=>'DR-002','NameUser'=>'poli.paru'],
            ['No_Reg'=>'REG-2026-006','No_MR'=>'MR-006','Kode_Masuk'=>'IGD','Kode_Asal'=>'UGD','Kode_Bayar'=>'3','PermintaanDPJP'=>'dr. Citra Sp.PD','Kode_Dokter'=>'DR-003','NameUser'=>'poli.paru'],
            ['No_Reg'=>'REG-2026-007','No_MR'=>'MR-007','Kode_Masuk'=>'IGD','Kode_Asal'=>'UGD','Kode_Bayar'=>'8','PermintaanDPJP'=>'dr. Andi Sp.An', 'Kode_Dokter'=>'DR-001','NameUser'=>'poli.dalam'],
            ['No_Reg'=>'REG-2026-077','No_MR'=>'MR-077','Kode_Masuk'=>'IGD','Kode_Asal'=>'UGD','Kode_Bayar'=>'1','PermintaanDPJP'=>'dr. Budi Sp.JP', 'Kode_Dokter'=>'DR-002','NameUser'=>'poli.jantung'],
            ['No_Reg'=>'REG-2026-088','No_MR'=>'MR-088','Kode_Masuk'=>'IGD','Kode_Asal'=>'UGD','Kode_Bayar'=>'2','PermintaanDPJP'=>'dr. Citra Sp.PD','Kode_Dokter'=>'DR-003','NameUser'=>'poli.paru'],
            ['No_Reg'=>'REG-2026-099','No_MR'=>'MR-099','Kode_Masuk'=>'IGD','Kode_Asal'=>'UGD','Kode_Bayar'=>'1','PermintaanDPJP'=>'dr. Andi Sp.An', 'Kode_Dokter'=>'DR-001','NameUser'=>'poli.dalam'],
        ] as $reg) Pendaftaran::create($reg);
    ...
    private function seedTransactionalData(): void
    {
        ...
        foreach ([
            [
                ...
                'jaminan' => 'BPJS', 'catatan_jaminan' => 'No. BPJS: 0001234567001',
        ...
        ] as $be) IcuBookingExternal::create($be);
        ...
        foreach ([
            [
                ...
                'Keterangan' => 'MAP < 65', 'NameUser' => 'Petugas Poli Dalam', 'status' => 'pending_admisi',
            ],
            [
                ...
                'Keterangan' => 'BNP tinggi', 'NameUser' => 'Petugas Poli Jantung',
                'catatan_admisi' => 'BPJS aktif.', 'approved_by' => 'Petugas Admisi 1', 'status' => 'pending_icu',
            ],
            [
                ...
                'Keterangan' => 'PaO2/FiO2 < 200', 'NameUser' => 'Petugas Poli Paru',
                'catatan_admisi' => 'BPJS kelas 1.',
                'allocated_bed_id' => 'HC307', 'nama_bed' => 'HIGH CARE UNIT 307',
                'approved_by' => 'Petugas Admisi 2', 'verified_by' => 'Petugas ICU 1', 'status' => 'bed_verified',
            ],
        ] as $si) IcuSpriInternal::create($si);
    }
}
