...
/**
 * Tabel lokal untuk data kunjungan/registrasi pasien.
 * Pada produksi, data ini dibaca dari SQL Server: DB_RSUS.dbo.PENDAFTARAN
 */
    ...
    public function up(): void
    {
        Schema::create('pendaftaran', function (Blueprint $table) {
            ...
            $table->foreign('No_MR')
                  ...
                  ->onDelete('cascade');
            $table->char('Kode_Masuk', 5)->nullable();      // IGD, RJ, dll.
